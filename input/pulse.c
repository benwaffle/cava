...
void getPulseDefaultSink(void *data) {
    ...
    void cb(__attribute__((unused)) pa_context * pulseaudio_context,
            const pa_server_info *i, __attribute__((unused)) void *userdata) {
    ...
    void pulseaudio_context_state_callback(
        __attribute__((unused)) pa_context * c, void *userdata) {
    ...
    pa_context_set_state_callback(pulseaudio_context,
                                  pulseaudio_context_state_callback, NULL);
...
void *input_pulse(void *data) {
    ...
    static const pa_buffer_attr pb = {.maxlength = BUFSIZE * 2,
                                      .fragsize = BUFSIZE};
    ...
    if (!(s = pa_simple_new(NULL, "cava", PA_STREAM_RECORD, audio->source,
        ...
        fprintf(stderr,
                __FILE__ ": Could not open pulseaudio source: %s, %s. To "
                         "find a list of your pulseaudio sources run "
                         "'pacmd list-sources'\n",
